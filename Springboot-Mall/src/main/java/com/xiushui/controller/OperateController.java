...
import com.xiushui.config.UserRealm;
...
public static void main(String[] args) {
	...
	System.out.println("23");
	 SimpleHash md5 = new SimpleHash("MD5", "root", ByteSource.Util.bytes("18723025086@163.com"), 2);
    ...
    */
    ...
    String datetime = simpleDateFormat.format(birth);
