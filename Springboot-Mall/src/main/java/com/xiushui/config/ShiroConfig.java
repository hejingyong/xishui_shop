...
//        filterChainMap.put("/role/**", "roles[user,admin]");
//        filterChainMap.put("/user/**", "roles[user,admin]");
//        filterChainMap.put("/userRole/**", "roles[user,admin]");
        filterChainMap.put("/product/**","anon");
        filterChainMap.put("/static/**","anon");
//        filterChainMap.put("order/**","roles[order,admin]");
    ...
    public RedisManager redisManager() {
        ...
        if(PropertiesUtil.getWay().equals("develop")){
            redisManager.setHost(PropertiesUtil.getServerHost());
        }else{
            redisManager.setHost(PropertiesUtil.getLocalHost());
        }
    ...
    public DefaultWebSessionManager sessionManager() {
        ...
        defaultWebSessionManager.setGlobalSessionTimeout(3600 * 1000);//1小时无操作自动过期
