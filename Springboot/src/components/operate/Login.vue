  ...
  <div style="perspective: 1000px;">
    <div class="login-wrap">
      <div id="login-vessel" parallaxstrength="4">
        <div class="login-box">
          <el-image src="http://127.0.0.1:9000/local/img/logo.jpg" class="nice-logo" alt="logo"></el-image>
...
<style>
  .login-wrap{
    ...
    align-items: center;
    padding: 15px;
    background: #5dd5c8 url(http://127.0.0.1:9000/local/img/bgimg.png) bottom no-repeat;
  }
  #login-vessel{
  ...
  .login-wrap .login-box {
    ...
    background: #fff url(http://127.0.0.1:9000/local/img/logbg.jpg) no-repeat bottom;
    text-align: center;
