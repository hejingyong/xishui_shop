    ...
    <div class="container">
      <div class="footer-service">
        <ul class="list-service clearfix">
          ...
          <li><i class="el-icon-present"></i>免费包邮</li>
          <li><i class="el-icon-location-outline"></i>多家网点</li>
        </ul>
      </div>
      <div class="footer-copyright">
        <div class="clearfix" style="width: 32%;min-width: 456px;margin: 0 auto;padding: 10px 0">
          <el-image src="http://127.0.0.1:9000/local/img/logo.jpg"></el-image>
          <div class="copyright">溪水公司版权所有 ©2023-{{new Date().getFullYear()}}</div>
        </div>
      </div>
    </div>
  </div>
