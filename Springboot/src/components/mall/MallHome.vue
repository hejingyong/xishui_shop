      ...
      <el-menu :default-active="activeIndex" class="el-menu-demo" :collapse-transition="false" active-text-color="#409EFF" mode="horizontal" @select="handleSelect">
        <el-menu-item index="1" style="width: 12%;margin-left:10%;position: relative">
          <router-link to="/MallHome" style="text-decoration: none;position: absolute;right: 0">
            <el-image style="width: 220px;height: 60px;" src="http://127.0.0.1:9000/local/img/logo.jpg"></el-image>
          </router-link>
        </el-menu-item>
    ...
    <div class="new-product">
      ...
      <div style="overflow: hidden">
        <div class="new-sale">
          ...
          <el-image style="width: 100px;padding: 20px;" src="http://127.0.0.1:9000/local/img/nurse.jpg"></el-image>
          <h3>新品专区</h3>
        </div>
    ...
    <div class="product clearfix">
      <div class="product-info" v-for="(value, key) in this.productsInfo" :key="key">
        ...
        <div class="clearfix" v-else style="float:left;display:flex;justify-content:center;align-items: center; width:83%;height: 75%;background-color: #FFF">
          <el-image style="width: 410px" src="http://127.0.0.1:9000/local/img/noproduct.png"></el-image>
        </div>
      </div>
    </div>
    <!--底部-->
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        carouselImage:[
          "http://127.0.0.1:9000/local/img/lb1.jpg",
          "http://127.0.0.1:9000/local/img/lb2.jpg",
          "http://127.0.0.1:9000/local/img/lb3.jpg",
          "http://127.0.0.1:9000/local/img/lb4.webp",
          "http://127.0.0.1:9000/local/img/lb5.jpg"
        ],
        bannerInfo:null,
        logoUrl:"http://127.0.0.1:9000/local/img/logo.jpg",
