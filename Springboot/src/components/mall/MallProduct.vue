    ...
    <div class="mall-info clearfix">
      ...
      <div class="mall-container clearfix" v-if="productInfo">
        ...
        <div v-else class="no-product">
          <el-image style="width:400px;height:388px" src="http://127.0.0.1:9000/local/img/noproduct.png"></el-image>
        </div>
      </div>
    </div>
    <!--底部-->
...
<style>
  ...
  .mall-product .product-hd{
    background: #f5f5f5 url(http://127.0.0.1:9000/local/img/title.png) 50% 0 no-repeat;
    height: 170px;
    position: relative;
  }
