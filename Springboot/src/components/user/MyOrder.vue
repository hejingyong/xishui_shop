<template>
  <div class="my-order">
    ...
    <div v-else class="no-order">
      <el-image style="width:400px;height:388px" src="http://127.0.0.1:9000/local/img/noorder.png"></el-image>
    </div>
    ...
    <el-dialog title="小客服" :visible.sync="serviceVisible" width="30%" style="padding: 0 20px 0">
      <el-image src="http://127.0.0.1:9000/local/img/weixin.jpg"></el-image>
  ...
  export default {
    ...
    data() {
      ...
      return{
        ...
        Parcel: ['溪水物流','邮政快递','中通快递','圆通快递','百世快递'],
    ...
    methods:{
      ...
      payment(orderNo,orderTime,productName,payPrice,productType){
        if(this.isTimeOut(orderTime)){
          ...
          let orderName = '溪水商城-'+productType+'-'+productName+'支付订单';
